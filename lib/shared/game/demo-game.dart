...
import 'package:flutter/gestures.dart'; // 取隨機數
...
//    c.drawRect(flyRect, flyPaint);
  ...
  void update(double t) {
    ...
    if(isDead){
      ...
      Offset toTarget = targetLocation - Offset(flyRect.left,flyRect.top); // 目標跟蒼蠅的Offset
      if(stepDistance < toTarget.distance){ // 代表還沒到這個offset
  ...
  void setTargetLocation(){
    double x = game.random.nextDouble() * (game.screenSize.width - game.tileSize);
    double y = game.random.nextDouble() * (game.screenSize.height - game.tileSize);
